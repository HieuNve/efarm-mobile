...
const ControllerComponent = ({ data, loading, onChangeV }) => {
  const currentValue = data.relay1;
      ...
      {!loading && (
        <View style={{ flex: 1, paddingVertical: 20 }}>
          <View
            ...
            <View
              style={styles.device}>
              <Text style={{ fontSize: 20, paddingHorizontal: 20, color: '#259125', fontWeight: 'bold' }}>Máy bơm</Text>
              <Switch
                ...
                onValueChange={(value) => {
                  console.log('value', value);
                  setIsEnabled(previousState => !presviousState);
          ...
          <View
            style={styles.ledWrapper} >
            <View
              style={styles.led}>
              <Text style={{ fontSize: 20, paddingHorizontal: 20, fontWeight: 'bold', color: '#259125' }}>Đèn   </Text>
              <Switch
                style={{ transform: [{ scaleX: 1.5 }, { scaleY: 1.5 }] }}
                trackColor={{ false: '#767577', true: '#81b0ff' }}
          ...
          <View
            style={styles.waterWrapper} >
            <View
              style={styles.water}>
              <Text style={{ fontSize: 20, paddingHorizontal: 20, fontWeight: 'bold', color: '#259125' }}>Phun Sương</Text>
              <Switch
                style={{ transform: [{ scaleX: 1.5 }, { scaleY: 1.5 }] }}
                trackColor={{ false: '#767577', true: '#81b0ff' }}
