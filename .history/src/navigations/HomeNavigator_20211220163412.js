...
const HomeNavigator = () => {
  ...
  return (
    <HomeStack.Navigator
      ...
      <HomeStack.Screen name={"Cài Đặt"} component={Setting}></HomeStack.Screen>
      <HomeStack.Screen
        name={FARM_DETAIL}
        component={FarmDetail}></HomeStack.Screen>
      <HomeStack.Screen name={DEVICE} component={Device}></HomeStack.Screen>
      <HomeStack.Screen
        name={CONTROLLER}
        component={Controller}></HomeStack.Screen>
      <HomeStack.Screen name={USER} component={User}></HomeStack.Screen>
      <HomeStack.Screen
        name={CREATE_FARM}
        component={CreateFarm}></HomeStack.Screen>
